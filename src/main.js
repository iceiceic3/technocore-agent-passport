...
app.innerHTML = `
  ...
  <main>
    ...
    <section id="passport" class="panel passport hidden"><div class="panel-head"><span>02 / PASSPORT CARD</span><button id="download" class="ghost">DOWNLOAD PNG ↓</button></div><div class="card" id="card"><div><p class="card-kicker">FLOP AGENT / VERIFIED IDENTITY</p><h2>Technocore<br>Agent Passport</h2><p class="card-did" id="cardDid"></p><div class="badges"><span>ED25519</span><span id="cardStatus">CHECKED</span></div></div><canvas id="qr"></canvas><div class="card-footer"><span id="cardActivity">Public proof lookup</span><span>technocore.chat</span></div></div></section>
